...
public class MainFrame extends JFrame implements ActionListener {
	...
	private CustomJTree messagepanel;
	public MainFrame(String title) throws HeadlessException {
		...
		TreeNode reee = messagepanel.getRootNode();
		System.out.println(reee);
		{
			for(int i =0; i<reee.getChildCount();i++){
				System.out.println(reee.getChildAt(i));
				if(reee.getChildAt(i).toString() == "USA"){
					DefaultMutableTreeNode child = (DefaultMutableTreeNode) reee.getChildAt(i);
					child.add(new DefaultMutableTreeNode("TEXAS"));
				}
			}
		}
		splitPane.add(messagepanel);
